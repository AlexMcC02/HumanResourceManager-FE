        ...
        >
          <div className="flex justify-between items-center">
            ...
            <input
              ...
              id="first_name"
              name="first_name"
              placeholder={existingEmployeeData?.firstName}
              value={firstName}
          ...
          <div className="flex justify-between items-center space-x-10">
            ...
            <input
              ...
              id="second_name"
              name="second_name"
              placeholder={existingEmployeeData?.secondName}
              value={secondName}
          ...
          <div className="flex justify-between items-center space-x-10">
            ...
            <input
              ...
              id="job_role"
              name="job_role"
              placeholder={existingEmployeeData?.jobRole}
              value={jobRole}
